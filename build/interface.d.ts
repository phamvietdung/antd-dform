 ...
 *
 */
export declare type IFieldType = 'input' | 'password' | 'datetime' | 'datetimeRange' | 'time' | 'number' | 'textarea' | 'select' | 'heading' | 'radio' | 'checkbox' | 'confirm' | 'selectMultiple' | 'hidden' | 'multiple-value';
/**
 * @name IField
 * @interface
 */
 ...
 * @type
 */
export declare type IDataRemote = (search?: string, id?: any) => Promise<any>;
/**
 * @name IConditionFunction
 * @type
 */
export declare type IConditionFunction = (obj: Object) => boolean;
/**
 * @name IConditionFunction
 * @type
